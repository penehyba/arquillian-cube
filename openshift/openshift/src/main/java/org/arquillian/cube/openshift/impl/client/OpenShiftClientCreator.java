...
public class OpenShiftClientCreator {
    ...
    public void createClient(@Observes AfterStart afterStart, Configuration conf) {
        ...
        if (kubernetesClient != null && kubernetesClient.isAdaptable(io.fabric8.openshift.clnt.v4_12.OpenShiftClient.class)) {
            io.fabric8.openshift.clnt.v4_12.OpenShiftClient client = kubernetesClient.adapt(io.fabric8.openshift.clnt.v4_12.OpenShiftClient.class);
    ...
    public OpenShiftClient createClient(io.fabric8.openshift.clnt.v4_12.OpenShiftClient client, Config openShiftConfig, String namespace, boolean keepAliveGitServer) {
