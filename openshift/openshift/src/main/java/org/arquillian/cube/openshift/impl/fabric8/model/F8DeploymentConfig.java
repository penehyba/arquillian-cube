...
public class F8DeploymentConfig implements DeploymentConfig {
    ...
    private final io.fabric8.openshift.api.model.v4_12.DeploymentConfig delegate;

    /**
     * Create a new F8DeploymentConfig.
     */
    public F8DeploymentConfig(final io.fabric8.openshift.api.model.v4_12.DeploymentConfig delegate) {
